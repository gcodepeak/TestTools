...
jQuery('body').on('click','#yt1',function(){jQuery.ajax({'url':'/zhubo/jingtiaoxixuan?tag=','cache':false,'success':function(html){jQuery("#jingtiaoxixuan").html(html);imageHover()}});return false;});
jQuery('body').on('click','#yt2',function(){jQuery.ajax({'url':'/zhubo/jingtiaoxixuan?tag=22','cache':false,'success':function(html){jQuery("#jingtiaoxixuan").html(html);imageHover()}});return false;});
jQuery('body').on('click','#yt3',function(){jQuery.ajax({'url':'/zhubo/jingtiaoxixuan?tag=27','cache':false,'success':function(html){jQuery("#jingtiaoxixuan").html(html);imageHover()}});return false;});
jQuery('body').on('click','#yt4',function(){jQuery.ajax({'url':'/zhubo/jingtiaoxixuan?tag=123','cache':false,'success':function(html){jQuery("#jingtiaoxixuan").html(html);imageHover()}});return false;});
jQuery('body').on('click','#yt5',function(){jQuery.ajax({'url':'/zhubo/jingtiaoxixuan?tag=122','cache':false,'success':function(html){jQuery("#jingtiaoxixuan").html(html);imageHover()}});return false;});
jQuery('body').on('click','#yt6',function(){jQuery.ajax({'url':'/zhubo/zuijiaxinren?time=7','cache':false,'success':function(html){jQuery("#zuijiaxinren").html(html);imageHover()}});return false;});
jQuery('body').on('click','#yt7',function(){jQuery.ajax({'url':'/zhubo/zuijiaxinren?time=14','cache':false,'success':function(html){jQuery("#zuijiaxinren").html(html);imageHover()}});return false;});
jQuery('body').on('click','#yt8',function(){jQuery.ajax({'url':'/zhubo/zuijiaxinren?time=30','cache':false,'success':function(html){jQuery("#zuijiaxinren").html(html);imageHover()}});return false;});
