...
<div class="container" id="page">
	<div class="row">
		<div class="col-md-6">
			<img src="<?php echo Yii::app()->request->baseUrl;?>/images/logo.png"></img>
		</div>
		...
		<div class="col-md-6">
			...
			<ul class="nav nav-pills nav-justified"> <!-- pull-right -->
			  ...
			  <li><a href="<?php Yii::app()->createUrl('zhubo/show')?>">主播大厅</a></li>
			  <li class="disabled"><a href="<?php echo Yii::app()->createUrl('')?>">我的关注</a></li>
			  <li class="dropdown">
			    <a class="dropdown-toggle"
			       data-toggle="dropdown"
			       href="#">收藏站点<b class="caret"></b>
			    </a>
			  ...
			  <li><a href="<?php echo Yii::app()->createUrl('')?>">网站合作</a></li>
			</ul>
		</div>
	</div>
	...
	<div id="footer">
		<div class="container">
			<div class="row" style="margin-bottom: 10px; margin-left: 2px">
				<div class="col-md-2"><span><strong>友情链接</strong></span></div>
			</div>
			<div class="row">
				<!-- 友情链接 -->
        		<div class="col-md-8">
        			<div class="col-md-2"><a href="http://mm.56.com/" target="_blank" title="美女主播">美女主播</a></div>
        			<div class="col-md-2"><a href="http://xiu.56.com/" target="_blank" title="我秀">我秀</a></div>
        			<div class="col-md-2"><a href="http://www.6.cn/" target="_blank" title="6间房">6间房</a></div>
        			<div class="col-md-2"><a href="http://x.joy.cn/" target="_blank" title="星秀">星秀</a></div>
        			<div class="col-md-2"><a href="http://fanxing.kugou.com/" target="_blank" title="酷狗繁星">酷狗繁星</a></div>
        			<div class="col-md-2"><a class="ftu" href="mailto:sites@xiu800.cn?subject=申请友情链接：贵网站名称" target="_blank" title="申请友链">[+申请友链]</a></div>
        		</div>
